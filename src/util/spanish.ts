export default {
  es: {
    ...
    notifications: {
      ...
      limit_reached: "solo puedes seleccionar hasta 4 archivos",
    ...
    uploader: {
      ...
      errors: {
        ...
        max_dimensions_validation:
          "Las dimensiones de la imagen ({{width}}X{{height}}) son mayores del máximo permitido: ({{maxWidth}}X{{maxHeight}})",
        min_dimensions_validation:
          "Las dimensiones de la imagen ({{width}}X{{height}}) son menores del mínimo permitido: ({{minWidth}}X{{minHeight}})",
        unavailable: "NA",
      ...
      close_mid_upload:
        "Hay cargas en proceso. Da clic en OK para cancelarlas.",
    },
    crop: {
      title: "Cortar",
      crop_btn: "Cortar",
    ...
    camera: {
      ...
      explanation:
        "Asegúrate que tu cámara esté conectada y que tu navegador permite capturas de pantalla. Cuando estés listo, da clic en Capturar.",
    ...
    image_search: {
      ...
      rights_options: {
        ...
        free_mod_com:
          "libre para usar, compartir o modificar, aún comercialmente",
      },
    ...
    shutterstock: {
      ...
      authenticating: "Autenticando…",
      statement:
        "Shutterstock ofrece la mejor calidad, imágenes sin regalías, fotos, vectores, ilustraciones, videos y música para casi cualquier aplicación.",
    ...
    i_stock: {
      ...
      no_auth_statement:
        "iStock by Getty Images es una de las tiendas de contenido de imágenes más importantes, ofreciendo millones de imágenes de primera calidad, elegidas manualmente a precios ridículamente bajos que sólo pueden ser obtenidos de nosotros.",
      reg_link_text:
        "Da clic aquí para crear una cuenta de iStock by Getty Images",
      search: {
        placeholder: "Buscar…",
        reset: "Reiniciar búsqueda",
      },
    ...
    metadataPage: {
      ...
      tooltip:
        "Algunos campos de metadata requeridos están vacíos o los valores proporcionados son incorrectos.",
      upload: "Cargar",
      conflict_label: "Sobrescribir",
      intro: {
        openingText:
          "Puedes llenar los siguientes campos para agregar nueva metadata a tus archivos a ser cargados.",
        conflictWarning:
          "Nota: Selecciona ‘Sobrescribir’ para los campos donde deseas aplicar los nuevos valores para archivos nuevos o a reemplazar.",
        closingText:
          "Después de cargar, puedes modificar la metadata para archivos individuales desde la librería de medios.",
      },
      closePrompt:
        "¿Estás seguro de querer cerrar esta caja de diálogo? Tus archivos no serán cargados.",
      backPrompt:
        "¿Estás seguro? Tu selección de archivos y su metadata asociada se perderá.",
      approveCancel: "Si",
      cancel: "Cancelar",
      validationErrors: {
        string: {
        ...
        enum: {
          oneOf:
            "{{originalValue}} debe ser una de las opciones indicadas previamente.",
        },
        set: {
          oneOf:
            "{{originalValue}} debe ser una de las opciones indicadas previamente.",
        ...
        unsupportedFields:
          "Por favor contacta a tu administrador, hay un problema con los siguientes campos de metadata: ",
        unsupportedRequiredFields:
          "Por favor contacta a tu administrador, hay un problema con los siguientes campos de metadata obligatorios: ",
      },
    },
  },
};
